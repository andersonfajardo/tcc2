            ...
            <main class="main-content">
                ...
                <div class="indicator-list">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr
                                v-for="(indicator, index) in this.indicators"
                                :key="indicator.id"
                            >
                    ...
                    <div class="form-container">
                        ...
                        >
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    type="text"
                                    v-model="newIndicator.kpidescription"
                                    id="kpidescriptio"
                                    required
                                />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select
                                    v-model="newIndicator.indicator_type"
                                    id="indicator_type"
                                    @change="updateChartPreview"
                                    required
                                >
                                    <option disabled value="">
                                        Selecione um tipo
...
export default {
    ...
    methods: {
        ...
        async saveIndicator() {
            try {
                ...
                if (this.isEditing) {
                    ...
                    response = await axios.post('/indicators', postdata);
                }
        ...
        editIndicator(index) {
            ...
            this.indicatorId = this.newIndicator.id;
